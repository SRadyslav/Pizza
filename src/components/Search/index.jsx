...
const Search = ({searchValue, setSearchValue}) => {
    return (
        <div className={styles.root}>
            ...
            <input className={styles.input} value={searchValue} onChange={(event)=>setSearchValue(event.target.value)} placeholder='Search...' />
            {searchValue &&
                <svg className={styles.close} onClick={()=>setSearchValue('')} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
