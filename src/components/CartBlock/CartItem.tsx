...
import { addItems, CartItemType, minusItem, removeItems } from '../../redux/slices/cartSlice'

type CartItemProps = { id: string,
    title: string,
    price: number,
    type:string,
    count: number,
...
const CartItem: React.FC<CartItemProps> = ({ id, title, price, type, count, size, imageUrl }) => {
